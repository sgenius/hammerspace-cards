...
This is a free-for-all battle where the objective is to be the last player standing.
...
Cards in the main deck come in three flavors: **attack**, **defense** and **ability**. 
...
- Mazo con ~48 cartas
- ~16 cartas de carácter
- 2 dados de 6 caras
- Contadores de vida con valores de 20, 5 y 1 vida

## Inicio
- Se revuelven el mazo principal y el mazo de carácter; se colocan sobre la mesa boca abajo.
- Cada jugador pone en la mesa, frente a sí y de manera que sea visible a los demás:
  + 4 cartas del mazo principal, boca arriba; una de ellas puede ser puesta boca abajo, ocultando su contenido.
  + 3 cartas de carácter, de las que se descarta una. Las otras dos se colocan boca arriba en la mesa; sus efectos serán válidos para este jugador durante todo el juego.
  + Contadores de vida, para sumar 30* puntos.
- El jugador que comienza es quien tenga la mayor puntuación al tirar dos dados. El siguiente turno sera para el jugador a su derecha, y así sucesivamente.

> * U otra cantidad. Mientras más puntos, más largo será el juego. 30 puntos con 4 jugadores son buenos para un juego de 30-40 minutos de duración.
...
El mazo principal tiene tres tipos de cartas:
...
- Si un jugador es atacado y tiene cartas de defensa boca arriba cuyo tipo corresponde al del ataque que recibe, esas cartas **deben** ser usadas.
  + Sin embargo, puede usar la menor cantidad de cartas que lo cubran por completo del ataque. Es decir, si tiene cartas que corresponden al tipo de ataque, pero sobran, pueden no ser usadas. El jugador puede elegir cuáles cartas de defensa usar en tal caso.
